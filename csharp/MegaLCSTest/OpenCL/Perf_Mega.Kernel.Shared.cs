...
Using device: 笔记本附带的显卡Radeon 500[gfx803]     Execution time:      466 ms AMD集成显卡半斤八两
Using device: 笔记本附带的显卡Intel(R) UHD620        Execution time:    1 932 ms intel不太行
...
Using device: 笔记本附带的显卡Radeon 500[gfx803]     Execution time:   42 189 ms 半斤八两
Using device: 笔记本附带的显卡Intel(R) UHD620        Execution time:  247 679 ms【intel显卡确实不太行】
...
public class Perf_Opencl{
    ...
    [Params(65536, 1048576, 2097152, 4194304)]
    public int MAX = 1024;
    ...
    private static void Test_KernelLCS_Shared(
        ...
        int[] horsOutExpect,
        int step){
        var allDevices = MegaLCSLib.OpenCL.Mega.GetAllDevices();
