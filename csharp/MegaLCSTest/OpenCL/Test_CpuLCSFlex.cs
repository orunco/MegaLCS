...
public class Test_CpuLCSFlex{
    [Test]
    public void test_ex(){
        Assert.Throws<Exception>(() => { Mega.CpuLCS_Flex([], [], [], []); });
        Assert.Throws<Exception>(() => { Mega.CpuLCS_Flex([5], [5], [5], []); });
        Assert.Throws<Exception>(() => { Mega.CpuLCS_Flex([5], [5], [], [5]); });
        Assert.Throws<Exception>(() => { Mega.CpuLCS_Flex([5], [], [5], [5]); });
        Assert.Throws<Exception>(() => { Mega.CpuLCS_Flex([], [5], [5], [5]); });
        ...
        Assert.Throws<Exception>(() => { Mega.CpuLCS_Flex([5, 6], [5], [5], [5, 6]); });
        Assert.Throws<Exception>(() => { Mega.CpuLCS_Flex([5], [5, 6], [5, 6], [5]); });
    }
    ...
    public void test_1x1(){
        // 无基础权重的测试用例 1
        {
            int[] verWeights =[0];
            int[] horWeights =[0];
            Mega.CpuLCS_Flex([5], [6], verWeights, horWeights);
...

        {
            int[] verWeights =[0];
            int[] horWeights =[0];
            Mega.CpuLCS_Flex([5], [5], verWeights, horWeights);
    ...
    public void test_2x2(){
        // 无基础权重的测试用例 1
        {
            int[] verWeights =[0, 0];
            int[] horWeights =[0, 0];
            Mega.CpuLCS_Flex([5, 6], [5, 6], verWeights, horWeights);
...

        {
            int[] verWeights =[0, 0];
            int[] horWeights =[0, 0];
            Mega.CpuLCS_Flex([5, 6], [7, 8], verWeights, horWeights);
    ...
    public void test_2x3(){
        // 有基础权重的测试用例 1
        {
            ...
            Mega.CpuLCS_Flex([5, 6, 7], [5, 6], verWeights, horWeights);
...

        {
            ...
            Mega.CpuLCS_Flex([5, 6], [5, 6, 7], verWeights, horWeights);
            Assert.That(verWeights, Is.EqualTo(new[]{ 12, 12 }));
